...
<input type="hidden" value=${id.i_user }>
<div id="changeInfo_div">
	...
	<div>
		...
		<div>
			<div>변경할 이름</div>
			<input class="changeNm" type="text">
		</div>
	...
	<div>
		...
		<div>
			<div>현재 비밀번호</div>
			<input class="changePw" type="password" placeholder="현재 비밀번호" name="pw">
		</div>
		<div>
			<div>새 비밀번호</div>
			<div>
	...
	<div>
		...
		<div>
			<div>변경할 별명</div>
			<input class="changeNick" type="text">
		</div>
		<div>별명 변경</div>
	</div>
	<div>
...
<script defer src="/res/js/chat/changeInfo.js?ver=4"></script>
